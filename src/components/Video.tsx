                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                src="https://github.com/danielsilva33.png"
                                alt="Foto do professor da aula"
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Daniel Silva</strong>
                                <span className="text-gray-200 text-sm block">CTO @Influeasy</span>
                            </div>
                        </div>
                    </div>
